    ...
    function process() {
        ...
        for (var i = 0, l = elements.length; i < l; i++) {
            ...
            if (e && e.style) {
                ...
                var moleculeData = e.getAttribute("data-molvwr-content");
...
(function (Molvwr) {
    ...
    (function (Elements) {
        Elements.elements = [
            ...
            { 'symbol': 'C', 'name': 'carbon', 'mass': 12.01070000, 'radius': 0.7300, 'color': [0.150, 0.150, 0.150], 'number': 6 },
            ...
            { 'symbol': 'V', 'name': 'vanadium', 'mass': 50.94150000, 'radius': 1.5300, 'color': [0.972, 0.537, 0.188], 'number': 23 },
    ...
    (function (ViewModes) {
        var Standard = (function () {
            ...
            Standard.prototype.createScene = function (context) {
                ...
                var camera = new BABYLON.ArcRotateCamera('Camera', CameraX, CameraY, CameraZ, new BABYLON.Vector3(0, 0, 0), context.scene);
